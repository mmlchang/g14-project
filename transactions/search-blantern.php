...
<body>
	<div>
		...
		<ul class="nav">
			...
			<li><a href="view-blantern.php">Transaction</a></li> <!--experiment view-member without result for html/css testing-->
	...
	<div class="page">
		...
		<div>
			<h3 class="title">Blessing Lantern: Search Details</h3>
			<hr/>
			
			<form>
				<input type="text" id="search-blantern" name="search" placeholder="Search">
