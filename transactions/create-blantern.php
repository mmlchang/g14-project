...
<body>
	...
	<div class="page">
		...
		<div>
			<h3 class="title">Blessing Lantern: Create Details</h3>
			<hr/>
			<form>
				<fieldset class="bl-column1">
					<label for="bl-id">Lantern ID:</label><br>
					<input type="text" id="bl-id" name="bl-id"><br>
					
					<label for="v-price">Price (Votive):</label><br>
					<input type="text" id="v-price" name="v-price" placeholder="RM"><br>

					<label for="b-price">Price (Blessing):</label><br>
					<input type="text" id="b-price" name="b-price" placeholder="RM"><br>
				</fieldset>
				
				<fieldset class="bl-column2">
