...
<body>
	<div>
		...
		<ul class="nav">
			...
			<li><a href="view-tablet.php">Transaction</a></li> <!--experiment view-member without result for html/css testing-->
	...
	<div class="page">
		...
		<div>
			<h3 class="title">Memorial Tablet: Search Details</h3>
			<hr/>
			
			<form>
				<input type="text" id="search-tablet" name="search" placeholder="Search">
